...
const audiences = [
  ...
  ["NGOs & charities", "Doing extraordinary work is one thing. Proving its lasting impact is another.", "We help charities and NGOs understand what is changing, build credible evidence and communicate it clearly."],
...
const homeSections = [
  ...
  ["contact", "Contact", ["promise", "contact", "newsletter"]],
] as const;
